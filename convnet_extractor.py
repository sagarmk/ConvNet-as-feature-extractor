...
# inspecting loaded MNIST dataset
...
# Defining covnet arch and training 
...
# We can get the activations for the dense layer and use these activations as features
# plotting 256 activations for the dense layer


pred = f_dense(instance)
N = pred.shape[1]
plt.title(" 256 activations for the dense layer")
plt.bar(range(N), pred.ravel())
plt.show()